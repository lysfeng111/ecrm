...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="返回首页" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="bl_list.do">病例管理</a><a href="bl_xiangqing.do?blCode=${bingLi.blCode }">病例详情</a> <a href="bl_xiugai.do?blCode=${bingLi.blCode }&zdysName=${zdysName}" class="current">病例修改</a></div>
        <h1>病例管理</h1>
        <div class="xinzen">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <form action="bl_update.do" method="post" class="form-inline" autocomplete="on" onsubmit="return checkForm()">
                <table width="900px" >
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                <label for="blName" class="sr-only">姓名：</label>
                                <input type="text" value="${bingLi.blName }"  class="form-control" name="blName" placeholder="姓名" required="required">
                            </div>
                        </td>
                        <td align="right">
                            <div class="form-group">
                                <label for="blCode" class="sr-only">病例号：</label>
                                <input type="text" value="${bingLi.blCode }" class="form-control" name="blCode" placeholder="病例号" readonly>
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                    ...
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="date" value="<fmt:formatDate value="${bingLi.blChushengDate}" pattern="yyyy-MM-dd"/>" class="form-control" name="blChushengDate" placeholder="出生日期" >
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label for="nianLing" class="sr-only">年齡：</label>
                                <input type="text" value="${bingLi.nianLing }" class="form-control" name="nianLing" placeholder="年齡" readonly>
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" value="${bingLi.blDianhua }" class="form-control" name="blDianhua" placeholder="手机号码" required="required">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label for="blJiatingDianhua" class="sr-only">家庭号码：</label>
                                <input type="text" value="${bingLi.blJiatingDianhua }"  class="form-control" name="blJiatingDianhua" placeholder="家庭号码" >
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" value="${bingLi.blZhengjianhao }" class="form-control" name="blZhengjianhao" placeholder="证件号" required="required">
                            </div>
                        </td>
                    </tr>
                    <tr><td><br></td></tr>
                    <tr align="right">
                        <td colspan="2" style="margin-left: 100px">
                            <div class="form-group">
                                ...
                                <input style="width: 657px " value="${bingLi.blDizhi }" type="text" class="form-control" name="blDizhi" placeholder="地址" >
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="date" value="<fmt:formatDate value="${bingLi.blRuyuanDate}" pattern="yyyy-MM-dd"/>" class="form-control" name="blRuyuanDate" placeholder="入院日期" required="required">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label for="blChuyuanDate" class="sr-only">出院日期：</label>
                                <input type="date" value="<fmt:formatDate value="${bingLi.blChuyuanDate}" pattern="yyyy-MM-dd"/>" class="form-control" name="blChuyuanDate" placeholder="出院日期" required="required">
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" value="${bingLi.blMzysName }" class="form-control" name="blMzysName" placeholder="门诊医生" >
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label for="blZyysCode" class="sr-only">住院医生：</label>
                                <input type="text" value="${bingLi.blZyysName }" class="form-control" name="blZyysName" placeholder="住院医生" >
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" value="${bingLi.blCyzd }" class="form-control" name="blCyzd" placeholder="出院诊断" required="required">
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" value="${zdysName }" class="form-control" name="blZdysName" placeholder="主刀医生" >
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                                <label for="blShoushuDate" class="sr-only">手术时间：</label>
                                <input type="date" value="${bingLi.blShoushuDate}" class="form-control" name="blShoushuDate" placeholder="手术时间" >
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                        <td colspan="2" style="margin-left: 100px">
                            <div class="form-group">
                                ...
                                <textarea style="resize: none;width: 657px" name="blXiangqing" placeholder="诊治情况" required="required">${bingLi.blXiangqing }</textarea>
                            </div>
                        </td>
                    </tr>
                </table>
                <input type="hidden" name="id" value="${bingLi.id }" />
                <button style="margin-left: 230px;margin-top: 20px" class="btn btn-success">确认修改</button>
            </form>
