...
<div id="content">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <form action="xzyonghu.do" method="post" class="form-inline" autocomplete="on" onsubmit="return checkForm()">
                <table width="600px" style="border-collapse:separate; border-spacing:0px 10px;">
                	<tr>
                        <td align="right">
                            <div class="form-group">
                                <label for="userName" class="sr-only">用户名：</label>
                                <input type="text" id="userName" value="${userName }" class="form-control" name="userName" placeholder="用户名" required="required" >
                            </div>
                        </td>
                    ...
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="password" id="passwd" value="${passwd }" class="form-control" name="passwd" placeholder="密码" required="required">
                            </div>
                        </td>
                    </tr>
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" value="${telephone }"  class="form-control" id="telephone" name="telephone" placeholder="电话" />
                            </div>
                        </td>
                    ...
                    <tr align="right">
                        <td>
                            <div class="form-group">
                                ...
                                <input type="text" value="${email }" id="email" class="form-control" name="email" placeholder="邮箱地址" />
                            </div>
                        </td>
                ...
                <button style="margin-left: 330px;margin-top: 20px" class="btn btn-success">添加用户</button>
            </form>
